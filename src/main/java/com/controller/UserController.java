...
public class UserController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(action.equalsIgnoreCase("sign up")) {
			boolean flag=UserDao.chechkEmail(request.getParameter("email"));
			if(flag==false) 
			{
				...
				{
					request.setAttribute("msg", "Password & ConfirmPassword doesnot matched");
		...
		else if(action.equalsIgnoreCase("change password"))
		{
			...
			if(u.getPassword().equals(request.getParameter("old_password")))
			{
					...
					{
						request.setAttribute("msg", "New password and Confirm New password doenot matched");
		...
		{
			String email=request.getParameter("email");
			String np=request.getParameter("new_passeord");
